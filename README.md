...
```python
python evaluate.py --session_directory 'YOUR SESSION DIRECTORY' --num_obj_complete N
```

## Demos (4x)

<img src="images/a.gif" alt="a" style="zoom: 40%;" />  <img src="images/b.gif" alt="b" style="zoom: 40%;" /> 

<img src="images/c.gif" alt="c" style="zoom: 40%;" />  <img src="images/d.gif" alt="d" style="zoom: 40%;" /> 
